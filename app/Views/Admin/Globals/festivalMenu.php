...
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details', $id) ?>" class="nk-menu-link">
        <span class="nk-menu-text">Festival Details</span>
    </a>
</li>
<li class="nk-menu-item">
...
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_venues', $id) ?>" class="nk-menu-link">
        <span class="nk-menu-text">Venues Page</span>
    </a>
</li>
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_schedules', $id) ?>" class="nk-menu-link">
...
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_jury', $id) ?>" class="nk-menu-link">
        <span class="nk-menu-text">Festival Jury</span>
    </a>
</li>

<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_gallery', $id) ?>" class="nk-menu-link">
        <span class="nk-menu-text">Festival Gallery</span>
    </a>
</li>
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_press', $id) ?>" class="nk-menu-link">
...
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_delegates', $id) ?>" class="nk-menu-link">
        <span class="nk-menu-text">Delegate Registrations</span>
    </a>
</li>
<li class="nk-menu-item">
...
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_selection', $id) ?>" class="nk-menu-link">
        <span class="nk-menu-text">Official Selections</span>
    </a>
</li>
<li class="nk-menu-item">
    <a href="<?= route_to('admin_festival_details_winners', $id) ?>" class="nk-menu-link">
        <span class="nk-menu-text">Winners</span>
    </a>
</li>
