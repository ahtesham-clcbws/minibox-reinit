        ...
        <div class="uk-card-media-top">
            ...
            <?php if ($event['video'] && !empty($event['video'])) : ?>
                <?php if ($event['video_type'] === 'youtube') : ?>
                    <iframe width="100%" height="430" src="https://www.youtube-nocookie.com/embed/<?= $event['video'] ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <?php endif; ?>
                <?php if ($event['video_type'] === 'vimeo') : ?>
                    <iframe width="100%" height="430" src="https://player.vimeo.com/video/<?= $event['video'] ?>?h=948f95b102&autoplay=1&title=0&byline=0&portrait=0" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                <?php endif; ?>
            <?php endif; ?>
        </div>
        <div class="uk-card-body">
            <div class="eventHeaderDetails" uk-grid>
                ...
                <div class="uk-width-1-3@m">
                    <a href="#register-now" title="Get Tickets" class="uk-button uk-button-secondary uk-width-1-1">Register now</a>
                            ...
                            <div class="uk-card uk-card-default uk-card-hover uk-padding-small">
                                <div class="">
                                    ...
                                    <div class="uk-button-group">
                                        <button class="uk-button uk-button-secondary" uk-tooltip="<?= $contact['email'] ?>"><span uk-icon="icon: mail"></span></button>
                                        <button class="uk-button uk-button-primary" uk-tooltip="<?= $contact['phone'] ?>"><span uk-icon="icon: receiver"></span></button>
                                        <button class="uk-button uk-button-secondary" uk-tooltip="<?= $contact['whatsapp'] ?>"><span uk-icon="icon: whatsapp"></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
