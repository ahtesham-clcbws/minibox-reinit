...
<section class="uk-section-small uk-section-default">
    <div class="uk-container">
        ...
        <div class="winner-cast-list">
            <div class="uk-container uk-grid" data-uk-grid="">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="winner-item">
                                <div class="winner-profile">
                                    <div class="winner-photo">
                                        <img width="100" height="100" src="http://sky360.in/mini_box_office/mini@1357admin/img/filmfestival/userform/1625902786-arrow-select.png" class="attachment-noxe-thumbnail-2 size-noxe-thumbnail-2 winner-lazy-load loaded" alt="Saif Husain Ansari" loading="lazy" data-ll-status="loaded">
                                    </div>
                                    <div class="winner-title">
                                        <span class="winner-subtitle">test</span>
                                        <span class="winner-name">Saif Husain Ansari</span>
                                    </div>
                                </div>
                                <div class="winner-details"></div>
                            </div>
                        ...
                        <li>
                            <div class="winner-item">
                                <div class="winner-profile">
                                    <div class="winner-photo">
                                        <img width="100" height="100" src="http://sky360.in/mini_box_office/mini@1357admin/img/filmfestival/userform/1646594798-_114319022_tv062954361.jpg" class="attachment-noxe-thumbnail-2 size-noxe-thumbnail-2 winner-lazy-load loaded" alt="manish" loading="lazy" data-ll-status="loaded">
                                    </div>
                                    <div class="winner-title">
                                        <span class="winner-subtitle">cameraman</span>
                                        <span class="winner-name">manish</span>
                                    </div>
                                </div>
                                <div class="winner-details"></div>
                            </div>
