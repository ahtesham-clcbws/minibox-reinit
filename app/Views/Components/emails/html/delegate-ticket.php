        ...
        <?php foreach ($items as $key => $item) : ?>
            <div class="ticket">
                ...
                <div class="ticket--center" style="position: relative; height: 290px; width: 619px;">
                    <div class="ticket--center--row">
                        <div class="ticket--center--col">
                            ...
                            <strong>for <?= strtoupper($movie_name) ?></strong>
                        </div>
                        <div class="ticket--center--col totalTickets textRight">
                            <span>
                                <span class="span"><?= $item['quantity'] ?></span><span class="small"><?= $item['quantity'] > 1 ? 'tickets' : 'ticket' ?></span>
                            </span>
                        </div>
                    </div>
                    <div class="ticket--center--row ticketDetailsRow">
                        <div class="ticket--center--col">
                            ...
                            <span class="ticket--info--content"><?= $item['details'] ?></span>
                        </div>
                    </div>
                    <div class="ticket--center--row">
                        <div class="ticket--center--col">
                            <span class="ticket--info--title">Tickets type</span>
                            <span class="ticket--info--content"><?= $ticket_type ?></span>
                        </div>
                ...
                <div class="ticket--end">
                    <div class="miniboxLogo"><img src="<?= base_url(MINIBOX_LOGO_ROTATED); ?>" /></div>
                </div>
            </div>
            <?php if ($key > 0) : ?>
