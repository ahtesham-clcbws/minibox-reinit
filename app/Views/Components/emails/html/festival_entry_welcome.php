          ...
          <tr>
            <td bgcolor="#ffffff" align="left" style="padding: 24px;  font-size: 16px; line-height: 24px;">
              ...
              <p style="margin: 0;">
                ...
                You payment is successfull, please fill out all the details about your movie/film <b>(<?= $movie_name ?>)</b> for official selection approval.<br /><br />
