...
!function (NioApp, $) {
  ...
  NioApp.ModeSwitch = function () {
    ...
    $(".dark-switch").on("click", function (e) {
      ...
      localStorage.setItem("dark_mode", "dark-mode");
      if (!$body.hasClass("dark-mode")) {
...
function alert(text = 'Your query is successfully sent.', title = 'Success', icon = 'success', type = 'text', confirmButtonText = null, showCancelButton = null, showCloseButton = null, focusConfirm = null, cancelButtonText = null) {
  var options = {};
  if (title) {
    options.title = title;
  }
...
function createHtmlElement(type, classes = [], attributes = [], appendElement = [], text = null) {
  ...
  appendElement.forEach(elementX => {
